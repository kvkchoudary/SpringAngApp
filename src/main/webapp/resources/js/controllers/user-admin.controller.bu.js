angular.module('useradmin.controllers',['ngAnimate', 'ui.grid', 'ui.grid.grouping', 'ui.grid.selection'])
    .controller('useradminController',["$scope","$rootScope","$http","$interval","$timeout","useradminService","useradminModel","uiGridConstants","$log","uiGridGroupingConstants","$state",
	function userAdminController($scope,$rootScope,$http, $interval, $timeout,useradminService,useradminModel,uiGridConstants, $log ,uiGridGroupingConstants,$state) {
	...
	function addUser() {
		$state.goto('uno.userAdmin.addUser');
    }
    ...
    function selectUser(data) {
          ...
          //data.isUnRead = false;
            ...
            $state.go('userAdmin.userDetails', searchParams);
          //}
    }
